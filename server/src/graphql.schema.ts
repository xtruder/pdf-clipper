...
export type ResolversTypes = ResolversObject<{
  ...
  DocumentOutlineInput: ResolverTypeWrapper<DeepPartial<DocumentOutlineInput>>;
  ...
  OutlineNodeInput: ResolverTypeWrapper<DeepPartial<OutlineNodeInput>>;
...
export type ResolversParentTypes = ResolversObject<{
  ...
  DocumentOutlineInput: DeepPartial<DocumentOutlineInput>;
  ...
  Mutation: {};
  OutlineNodeInput: DeepPartial<OutlineNodeInput>;
  Query: {};
