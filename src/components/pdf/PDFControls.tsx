...
// component imports
import { EditableText } from "../src/ui/EditableText";
...
export const PDFSidebarNavbar: React.FC<{
  title?: string;
...
export const PDFHighlightTooltip: React.FC<{
  className?: string;
...
export const PDFSelectionTooltip: React.FC<{
  onClick: () => void;
}> = ({ onClick }) => {
  return (
